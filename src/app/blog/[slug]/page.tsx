...
export default async function BlogPostPage({
  ...
  // Check if this article should show CNCS urgency variant (NIS2/CNCS related)
  const shouldShowCNCSUrgency = post.slug.includes('nis2') ||
    post.slug.includes('cncs') ||
    post.category === 'legislacao' ||
    post.title.toLowerCase().includes('nis2') ||
    post.title.toLowerCase().includes('cncs');
      ...
      <main id="main-content" className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="mt-12 mb-12">
          <AffiliateCTABanner
            ...
            variant={shouldShowCNCSUrgency ? "cncs-urgency" : "default"}
          />
        </div>
