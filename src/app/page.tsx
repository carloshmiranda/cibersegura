...
const DESCRIPTION = "Plataforma de ferramentas e consciencialização em cibersegurança para empresas portuguesas";
const VALUE_PROPOSITION = "Proteja o seu negócio com ferramentas de cibersegurança simples e eficazes";
...
const FEATURES = [
  {
    ...
    description: "Scans automáticos que identificam pontos fracos na sua infraestrutura",
  },
  {
    icon: (
      <svg className="w-6 h-6 text-gray-900" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    description: "Módulos de treino para sensibilizar os colaboradores sobre ameaças",
  },
  {
    icon: (
      <svg className="w-6 h-6 text-gray-900" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    description: "Alertas em tempo real para atividades suspeitas",
  },
];
...
const FAQS = [
  {
    q: "O que inclui a análise de vulnerabilidades?",
    a: "Fazemos scans completos dos seus sistemas, emails e websites para identificar potenciais pontos de entrada para ataques.",
  },
  {
    q: "Como funciona a formação da equipa?",
    a: "Disponibilizamos módulos interativos online que os seus colaboradores podem completar no seu próprio ritmo.",
  },
  {
    q: "Que tipo de monitorização oferecemos?",
    a: "Monitorizamos tentativas de acesso não autorizado, malware e outras atividades suspeitas 24 horas por dia.",
  },
];
            ...
            <div className="flex min-h-[340px] md:min-h-[420px]">
              ...
              <div className="flex-1 p-4 md:p-6 bg-white">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6">
                  {[
                    { label: "Ameaças Bloqueadas", value: "2,847", change: "+12.5%", up: true },
                    { label: "Vulnerabilidades", value: "€4,290", change: "+8.2%", up: true },
                    { label: "Uptime do Sistema", value: "94.2%", change: "-0.3%", up: false },
                  ].map((stat, i) => (
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-1">{`Avaliação Inicial`}</h3>
              <p className="text-sm text-gray-500">{`Analisamos os sistemas actuais da sua empresa`}</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-gray-500">{`Configuramos as ferramentas de protecção`}</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-1">{`Monitorização`}</h3>
              <p className="text-sm text-gray-500">{`Acompanhamento contínuo e relatórios`}</p>
            </div>
          </div>
